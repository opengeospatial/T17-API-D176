...
export class InstanceDataQueriesService {
     ...
     */
    public getInstanceDataForArea(collectionId: string, instanceId: string, coords: string, z?: string, datetime?: string, parameterName?: string, resolutionX?: object, resolutionY?: object, crs?: string, f?: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/prs.coverage+json' | 'application/geo+json' | 'application/x-netcdf' | 'text/xml' | 'application/json' | 'text/html', context?: HttpContext}): Observable<CoverageJSON>;
    public getInstanceDataForArea(collectionId: string, instanceId: string, coords: string, z?: string, datetime?: string, parameterName?: string, resolutionX?: object, resolutionY?: object, crs?: string, f?: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/prs.coverage+json' | 'application/geo+json' | 'application/x-netcdf' | 'text/xml' | 'application/json' | 'text/html', context?: HttpContext}): Observable<HttpResponse<CoverageJSON>>;
    public getInstanceDataForArea(collectionId: string, instanceId: string, coords: string, z?: string, datetime?: string, parameterName?: string, resolutionX?: object, resolutionY?: object, crs?: string, f?: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/prs.coverage+json' | 'application/geo+json' | 'application/x-netcdf' | 'text/xml' | 'application/json' | 'text/html', context?: HttpContext}): Observable<HttpEvent<CoverageJSON>>;
    public getInstanceDataForArea(collectionId: string, instanceId: string, coords: string, z?: string, datetime?: string, parameterName?: string, resolutionX?: object, resolutionY?: object, crs?: string, f?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/prs.coverage+json' | 'application/geo+json' | 'application/x-netcdf' | 'text/xml' | 'application/json' | 'text/html', context?: HttpContext}): Observable<any> {
